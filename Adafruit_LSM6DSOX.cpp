 ...
 */
boolean Adafruit_LSM6DSOX::begin_I2C(uint8_t i2c_address, TwoWire *wire,
                                     int32_t sensor_id) {
  ...
  Adafruit_BusIO_Register chip_id = Adafruit_BusIO_Register(
      i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LSM6DSOX_WHOAMI);

  // make sure we're talking to the right chip
  if ((chip_id.read() != LSM6DSOX_CHIP_ID) &&
      (chip_id.read() != ISM330DHCX_CHIP_ID)) {
    return false;
  }
 ...
 *    @return True if initialization was successful, otherwise false.
 */
bool Adafruit_LSM6DSOX::begin_SPI(int8_t cs_pin, int8_t sck_pin,
...
*/
/**************************************************************************/
bool Adafruit_LSM6DSOX::getEvent(sensors_event_t *accel, sensors_event_t *gyro,
...
lsm6dsox_data_rate_t Adafruit_LSM6DSOX::getGyroDataRate(void) {
  ...
  Adafruit_BusIO_Register ctrl2 = Adafruit_BusIO_Register(
      i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LSM6DSOX_CTRL2_G);
...
void Adafruit_LSM6DSOX::_read(void) {
  ...
  Adafruit_BusIO_Register data_reg = Adafruit_BusIO_Register(
      i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LSM6DSOX_OUT_TEMP_L, 14);
...
/**************************************************************************/
/*!
    @brief Sets the INT1 and INT2 interrupt active signal polarity
...
/*!
   ...
   mode to push-pull
*/
void Adafruit_LSM6DSOX::setIntOpenDrain(bool open_drain) {
...
/**************************************************************************/
/*!
    @brief Enables and disables the data ready interrupt on int1.
    @param enable_drdy true to enable the data ready interrupt, false to
   disable.
*/
void Adafruit_LSM6DSOX::setInt1DataReady(bool enable_drdy) {

  Adafruit_BusIO_Register int1_ctrl = Adafruit_BusIO_Register(
      i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LSM6DSOX_INT1_CTRL);
